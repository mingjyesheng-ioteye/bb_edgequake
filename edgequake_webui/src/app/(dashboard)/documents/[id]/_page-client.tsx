...
export default function DocumentViewPage() {
  ...
  // OODA-chunk-select: Local chunk selection state for sidebar ΓåÆ content highlighting.
   ...
   * SRP: This does NOT toggle selection ΓÇö it is a pure data resolution callback.
   */
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="hidden lg:flex flex-1 overflow-hidden">
          ...
          {/* Metadata Sidebar - Resizable (shown for all document types including PDF).
              ...
              used for PDF ΓåÆ Markdown transcription. Hiding it for PDF documents
